...
class EvaluationsTest < ApplicationSystemTestCase
  ...
  test "creating a Evaluation" do
    ...
    fill_in "Creative", with: @evaluation.creative
    fill_in "Focused", with: @evaluation.focused
    fill_in "Helpful", with: @evaluation.helpful
    fill_in "Leadership", with: @evaluation.leadership
    fill_in "Rated", with: @evaluation.rated_id
    fill_in "Rater", with: @evaluation.rater_id
    fill_in "Responsible", with: @evaluation.responsible
